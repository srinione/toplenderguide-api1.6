...
LENDER_SPREADS = {
    # ── Lowest rates / credit unions / online-first ──────────────────────────
    "thirdfederal": {"name": "Third Federal Savings",          "spread_30": -0.09, "spread_15": -0.08, "spread_arm": -0.11, "min_credit": 620, "min_down": 5.0},
    ...
    "ally":         {"name": "Ally Bank Home Loans",           "spread_30": -0.04, "spread_15": -0.03, "spread_arm": -0.06, "min_credit": 620, "min_down": 3.0},
    "better":       {"name": "Better Mortgage",                "spread_30": -0.03, "spread_15": -0.02, "spread_arm": -0.10, "min_credit": 620, "min_down": 5.0},
    "pennymac":     {"name": "PennyMac",                       "spread_30": -0.02, "spread_15": -0.01, "spread_arm": -0.04, "min_credit": 620, "min_down": 3.0},
    # ── Near-market / competitive non-banks ─────────────────────────────────
    "guaranteed":   {"name": "Guaranteed Rate",                "spread_30": +0.01, "spread_15": +0.01, "spread_arm": -0.02, "min_credit": 580, "min_down": 3.0},
    "newamerican":  {"name": "New American Funding",           "spread_30": +0.02, "spread_15": +0.01, "spread_arm": -0.01, "min_credit": 500, "min_down": 3.0},
    "flagstar":     {"name": "Flagstar Bank Mortgage",         "spread_30": +0.03, "spread_15": +0.02, "spread_arm": +0.00, "min_credit": 620, "min_down": 3.0},
    "newrez":       {"name": "NewRez",                         "spread_30": +0.04, "spread_15": +0.03, "spread_arm": +0.01, "min_credit": 580, "min_down": 3.0},
    "freedom":      {"name": "Freedom Mortgage",               "spread_30": +0.05, "spread_15": +0.04, "spread_arm": +0.02, "min_credit": 550, "min_down": 3.5},
    "crosscountry": {"name": "CrossCountry Mortgage",          "spread_30": +0.06, "spread_15": +0.05, "spread_arm": +0.03, "min_credit": 580, "min_down": 3.0},
    "mrcooper":     {"name": "Mr. Cooper",                     "spread_30": +0.07, "spread_15": +0.06, "spread_arm": +0.04, "min_credit": 580, "min_down": 3.0},
    "fairway":      {"name": "Fairway Independent Mortgage",   "spread_30": +0.08, "spread_15": +0.07, "spread_arm": +0.05, "min_credit": 580, "min_down": 3.0},
    "guild":        {"name": "Guild Mortgage",                 "spread_30": +0.09, "spread_15": +0.08, "spread_arm": +0.07, "min_credit": 600, "min_down": 3.0},
    "movement":     {"name": "Movement Mortgage",              "spread_30": +0.10, "spread_15": +0.09, "spread_arm": +0.07, "min_credit": 580, "min_down": 3.0},
    # ── Above-market / large banks ───────────────────────────────────────────
    "rocket":       {"name": "Rocket Mortgage",                "spread_30": +0.12, "spread_15": +0.10, "spread_arm": +0.08, "min_credit": 580, "min_down": 3.0},
    "chase":        {"name": "Chase Home Lending",             "spread_30": +0.14, "spread_15": +0.12, "spread_arm": +0.10, "min_credit": 620, "min_down": 3.0},
    "pnc":          {"name": "PNC Bank Mortgage",              "spread_30": +0.16, "spread_15": +0.13, "spread_arm": +0.12, "min_credit": 620, "min_down": 3.0},
    "usbank":       {"name": "U.S. Bank Home Mortgage",        "spread_30": +0.18, "spread_15": +0.15, "spread_arm": +0.13, "min_credit": 620, "min_down": 3.0},
    "bofa":         {"name": "Bank of America",                "spread_30": +0.19, "spread_15": +0.15, "spread_arm": +0.14, "min_credit": 660, "min_down": 3.0},
    "citi":         {"name": "CitiMortgage",                   "spread_30": +0.21, "spread_15": +0.18, "spread_arm": +0.16, "min_credit": 620, "min_down": 3.0},
    "truist":       {"name": "Truist Mortgage",                "spread_30": +0.22, "spread_15": +0.19, "spread_arm": +0.17, "min_credit": 620, "min_down": 3.0},
